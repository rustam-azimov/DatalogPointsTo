...
public class FactDatabase implements Closeable, Flushable {
     ...
     */
    public FactDatabase(String directory) throws IOException {
        this(directory, true);
    }
     ...
     */
    public FactDatabase(String directory, boolean initWriters) throws IOException {
